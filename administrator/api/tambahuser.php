...
if(!(isset($_POST['username']) && isset($_POST['password']) && isset($_POST['nama']) && isset($_POST['telp']) && isset($_POST['level']) && $level[$_POST['level']])){
...
if($admin['level'] === 'admin'){
    try{
        ...
        echo json_encode(['status' => $userbaru->daftar($_POST['nama'], $_POST['telp'], $level[$_POST['level']])], JSON_PRETTY_PRINT);
        exit();
    }catch(Exception $e){
        echo json_encode(['status' => false], JSON_PRETTY_PRINT);
        exit();
